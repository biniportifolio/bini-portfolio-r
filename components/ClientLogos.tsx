            ...
            <div className="max-w-5xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
                ...
                >
                    {clients.map(client => (
                        ...
                        >
                            <div className="h-8 md:h-9 text-text-secondary dark:text-[#94A3B8] opacity-60 group-hover:opacity-100 group-hover:text-text-primary dark:group-hover:text-white transition-all duration-300 transform group-hover:scale-110" data-cursor-variant="link">
                                {client.logo}
                            </div>
                        </motion.div>
                    ))}
